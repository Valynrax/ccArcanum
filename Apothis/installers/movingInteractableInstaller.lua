local NAME = "Apothis Moving Interactable Installer"
...
DOWNLOADS[#DOWNLOADS + 1] = "https://raw.githubusercontent.com/Valynrax/ccArcanum/refs/heads/main/Apothis/other/movingInteractable.lua"
...
local barLine = 6
local line = 8
local installFolder = "apothisMovingInteractable"
...
local function rewriteStartup()
    ...
    file.writeLine("shell.run(\"".. installFolder .. "/movingInteractableInstaller.lua\")")
    file.writeLine("while (true) do")
    file.writeLine("	shell.run(\"" .. installFolder .. "/movingInteractable.lua\")")
