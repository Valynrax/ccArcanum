local NAME = "Apothis Interactable Installer"
...
DOWNLOADS[#DOWNLOADS + 1] = "https://raw.githubusercontent.com/Valynrax/ccArcanum/refs/heads/main/Apothis/other/interactable.lua"
...
local barLine = 6
local line = 8
local installFolder = "apothisInteractable"
...
local function rewriteStartup()
    ...
    file.writeLine("shell.run(\"".. installFolder .. "/interactableInstaller.lua\")")
    file.writeLine("while (true) do")
    file.writeLine("	shell.run(\"" .. installFolder .. "/interactable.lua\")")
