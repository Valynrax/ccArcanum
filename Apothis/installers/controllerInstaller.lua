local NAME = "Apothis Controller Installer"
...
local barLine = 6
local line = 8
local installFolder = "apothisController"
...
local function rewriteStartup()
    ...
    file.writeLine("shell.run(\"".. installFolder .. "/controllerInstaller.lua\")")
    file.writeLine("while (true) do")
    file.writeLine("	shell.run(\"" .. installFolder .. "/controller.lua\")")
